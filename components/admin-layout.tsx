      ...
      >
        ...
        <nav className="flex-1 px-2 py-4">
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/admin/drivers" className="block px-4 py-2 rounded hover:bg-gray-100">
                Drivers
              </Link>
            </li>
            <li>
              <Link href="/admin/vehicles" className="block px-4 py-2 rounded hover:bg-gray-100">
                Vehicles
              </Link>
            </li>
          </ul>
